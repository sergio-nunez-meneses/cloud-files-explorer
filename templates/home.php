<?php
$title = 'simple files cloud';
include '../include/header.php';
?>

<main class="main-container" style="display: <?php echo $display_content; ?>">
  <section class="forms-btns-container" style="display: flex; padding: 1rem 0;">
